...
def main():
    ...
    gconv1 = GConv(input_dim=dataset.num_features, hidden_dim=8, num_layers=2).to(device)
    gconv2 = GConv(input_dim=dataset.num_features, hidden_dim=8, num_layers=2).to(device)
